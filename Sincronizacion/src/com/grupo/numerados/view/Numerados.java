...
public class Numerados extends JPanel implements ActionListener, FocusListener {
  ...
  private JScrollPane getScrollPane() {
    if (scrollPane == null) {
      ...
      scrollPane.setBorder(new CompoundBorder(new TitledBorder(UIManager
          .getBorder("TitledBorder.border"), "", TitledBorder.LEADING, TitledBorder.TOP, null,
          new Color(0, 0, 0)), new EtchedBorder(EtchedBorder.LOWERED, null, null)));
  ...
  protected void fillProduct(String text) {
    ...
    if (txtArticulo.getText() != null && txtArticulo.getText().length() == 3) {
      ...
      if (indice > 99) {
        ...
        JOptionPane.showMessageDialog(this, "Cantidad de piezas del " + txtArticulo.getText()
            + " es mayor a 99.", "Número de piezas", JOptionPane.ERROR_MESSAGE);
        lblNombre.setText("");
        txtArticulo.setText("");
  ...
  public void actionPerformed(final ActionEvent actionEvent) {
    if (ADD.equals(actionEvent.getActionCommand())) {
      ...
      int resultado =
          JOptionPane
              .showConfirmDialog(this, "Confirma la eliminación de productos seleccionados.");
      ...
      int resultado =
          JOptionPane.showConfirmDialog(this, "Confirma eliminación de todos los productos.");
      if (resultado == JOptionPane.OK_OPTION) {
  ...
  public void fillProducts() {
    SwingWorker<List<ProductosNumerados>, Object> work =
        new SwingWorker<List<ProductosNumerados>, Object>() {
          @Override
